// kommivoager.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
void Button1()
{
	...
	glBegin(GL_QUADS);
	glVertex2i(13, WinH - 13);
	glVertex2i(13, WinH - WinH / 8);
	glVertex2i(WinW / 7, WinH - WinH / 8);
	glVertex2i(WinW / 7, WinH - 13);
	glEnd();
	...
	glRasterPos2i(45, WinH - 0.5 * WinH / 7);
...
void Button2()
{
	if (but == 6)
		...
		glColor3f(0.3f, 0.5f, 1.0f);
	glBegin(GL_QUADS);
	glVertex2i(13, (WinH - 4 * WinH / 7) + 39);
	glVertex2i(13, WinH - 5 * WinH / 8);
	glVertex2i(WinW / 7, WinH - 5 * WinH / 8);
	glVertex2i(WinW / 7, (WinH - 4 * WinH / 7) + 39);
	glEnd();
	glColor3f(0.0f, 0.0f, 0.0f);
	glBegin(GL_LINE_LOOP);
	glVertex2i(13, (WinH - 4 * WinH / 7) + 39);
	...
	glRasterPos2i(45, (WinH - 4.5 * WinH / 7) + 50);
	for (int i = 0; i < name.length(); i++)
		glutBitmapCharacter(GLUT_BITMAP_HELVETICA_12, name[i]);
}
...
void Button3()
{
	if (but == 3)
		...
		glColor3f(0.3f, 0.5f, 1.0f);
	glBegin(GL_QUADS);
	glVertex2i(13, (WinH - 2 * WinH / 7) + 13);
	glVertex2i(13, WinH - 3 * WinH / 8);
	glVertex2i(WinW / 7, WinH - 3 * WinH / 8);
	glVertex2i(WinW / 7, (WinH - 2 * WinH / 7) + 13);
	glEnd();
	glColor3f(0.0f, 0.0f, 0.0f);
	glBegin(GL_LINE_LOOP);
	glVertex2i(13, (WinH - 2 * WinH / 7) + 13);
	...
	glRasterPos2i(40, (WinH - 2.5 * WinH / 7) + 20);
	for (int i = 0; i < name.length(); i++)
		glutBitmapCharacter(GLUT_BITMAP_HELVETICA_12, name[i]);
}
...
void Button4()
{
	if (but == 4)
		...
		glColor3f(0.3f, 0.5f, 1.0f);
	glBegin(GL_QUADS);
	glVertex2i(13, (WinH - 3 * WinH / 7) + 26);
	glVertex2i(13, WinH - 4 * WinH / 8);
	glVertex2i(WinW / 7, WinH - 4 * WinH / 8);
	glVertex2i(WinW / 7, (WinH - 3 * WinH / 7) + 26);
	glEnd();
	glColor3f(0.0f, 0.0f, 0.0f);
	glBegin(GL_LINE_LOOP);
	glVertex2i(13, (WinH - 3 * WinH / 7) + 26);
	...
	glRasterPos2i(50, (WinH - 3.5 * WinH / 7) + 35);
	for (int i = 0; i < name.length(); i++)
		glutBitmapCharacter(GLUT_BITMAP_HELVETICA_12, name[i]);
}
...
void Button5()
{
	if (but == 2)
		...
		glColor3f(0.3f, 0.5f, 1.0f);
	glBegin(GL_QUADS);
	glVertex2i(13, WinH - WinH / 7);
	glVertex2i(13, WinH - 2 * WinH / 8);
	glVertex2i(WinW / 7, WinH - 2 * WinH / 8);
...
void Button6()
{
	if (but == 5)
		...
		glColor3f(0.3f, 0.5f, 1.0f);
	glBegin(GL_QUADS);
	glVertex2i(13, (WinH - 5 * WinH / 7) + 52);
	glVertex2i(13, WinH - 6 * WinH / 8);
	glVertex2i(WinW / 7, WinH - 6 * WinH / 8);
	glVertex2i(WinW / 7, (WinH - 5 * WinH / 7) + 52);
	glEnd();
	glColor3f(0.0f, 0.0f, 0.0f);
	glBegin(GL_LINE_LOOP);
	glVertex2i(13, (WinH - 5 * WinH / 7) + 52);
	...
	glRasterPos2i(40, (WinH - 5.5 * WinH / 7) + 60);
	for (int i = 0; i < name.length(); i++)
		glutBitmapCharacter(GLUT_BITMAP_HELVETICA_12, name[i]);
}
...
{
	if (x > 13 && x < WinW / 7 && y < (WinH - 13) && y >(WinH - WinH / 8))
		but = 1;
	else if (x > 13 && x < WinW / 7 && y < (WinH - WinH / 7) && y >(WinH - 2 * WinH / 8))
		but = 2;
	else if (x > 13 && x < WinW / 7 && y >(WinH - 3 * WinH / 8) && y < ((WinH - 2 * WinH / 7) + 13))
		but = 3;
	else if (x > 13 && x < WinW / 7 && y >(WinH - 4 * WinH / 8) && y < ((WinH - 3 * WinH / 7) + 26))
		but = 4;
	else if (x > 13 && x < WinW / 7 && y >(WinH - 6 * WinH / 8) && y < ((WinH - 5 * WinH / 7) + 52))
		but = 5;
	else if (x > 13 && x < WinW / 7 && y >(WinH - 5 * WinH / 8) && y < ((WinH - 4 * WinH / 7) + 39))
		but = 6;
	else
		but = 0;
}
